...
My PhD at the University of Georgia, with [Sheng Li](https://sheng-li.org/), was about knowledge — specifically, how to get structured knowledge that language models were never trained on into the models anyway. Domain-adapted encoders for agriculture and clinical text, knowledge graphs built out of raw documents. Along the way I spent time at Adobe Research and Reuters. It was good work, and the thing I kept running into was not the modeling. It was that I could never fully convince myself the numbers meant what everyone assumed they meant.
